...
print("
    <h2>На сайте можно:</h2>
    <p>
        Регистрироваться, логиниться, log out, добавлять задачи, удалять задачи, отмечать статус выполнения задачи, редактировать имя задачи, менять порядок задач,
        менять текущий пароль, менять текущее имя, отслеживать свой уникальный ID, отслеживать общее количество своих задач,
        отслеживать соотношение выполненых/невыолненых задач в виде диаграммы.
    </p>
    <p>
        В ходе разработки сайта использовались следующие технологии: HTML5, CSS3, PHP, JavaScript, MySQL.
    </p>
    ");
