...
print("
    ...
    <p>
        Добавлять задачи, удалять задачи, отмечать статус выполнения задачи, редактировать имя задачи, менять порядок задач,
    ...
    <p>
        В ходе разработки сайта использовались следующие технологии: HTML, CSS, PHP, JavaScript, MySQL.
    </p>
    ");
